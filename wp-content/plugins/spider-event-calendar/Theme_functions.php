...
function apply_theme_calendar($id) {
  ...
  $arrow_color_month = ((isset($_POST["arrow_color_month"])) ? esc_sql(esc_html(stripslashes($_POST["arrow_color_month"]))) : '');
  $next_month_text_color = ((isset($_POST["next_month_text_color"])) ? esc_sql(esc_html(stripslashes($_POST["next_month_text_color"]))) : '');
  $next_month_font_size = ((isset($_POST["next_month_font_size"])) ? esc_sql(esc_html(stripslashes($_POST["next_month_font_size"]))) : '');
  $next_month_arrow_color = ((isset($_POST["next_month_arrow_color"])) ? esc_sql(esc_html(stripslashes($_POST["next_month_arrow_color"]))) : '');
  $prev_month_text_color = ((isset($_POST["prev_month_text_color"])) ? esc_sql(esc_html(stripslashes($_POST["prev_month_text_color"]))) : '');
  $prev_month_font_size = ((isset($_POST["prev_month_font_size"])) ? esc_sql(esc_html(stripslashes($_POST["prev_month_font_size"]))) : '');
  $prev_month_arrow_color = ((isset($_POST["prev_month_arrow_color"])) ? esc_sql(esc_html(stripslashes($_POST["prev_month_arrow_color"]))) : '');
  $arrow_size = ((isset($_POST["arrow_size"])) ? esc_sql(esc_html(stripslashes($_POST["arrow_size"]))) : '');
  $text_color_week_days = ((isset($_POST["text_color_week_days"])) ? esc_sql(esc_html(stripslashes($_POST["text_color_week_days"]))) : '');
  $week_days_cell_height = ((isset($_POST["week_days_cell_height"])) ? esc_sql(esc_html(stripslashes($_POST["week_days_cell_height"]))) : '');
  $weekdays_bg_color = ((isset($_POST["weekdays_bg_color"])) ? esc_sql(esc_html(stripslashes($_POST["weekdays_bg_color"]))) : '');
  $weekday_sunday_bg_color = ((isset($_POST["weekday_sunday_bg_color"])) ? esc_sql(esc_html(stripslashes($_POST["weekday_sunday_bg_color"]))) : '');
  $weekdays_font_size = ((isset($_POST["weekdays_font_size"])) ? esc_sql(esc_html(stripslashes($_POST["weekdays_font_size"]))) : '');
  $bg_bottom = ((isset($_POST["bg_bottom"])) ? esc_sql(esc_html(stripslashes($_POST["bg_bottom"]))) : '');
  $cell_height = ((isset($_POST["cell_height"])) ? esc_sql(esc_html(stripslashes($_POST["cell_height"]))) : '');
  $text_color_other_months = ((isset($_POST["text_color_other_months"])) ? esc_sql(esc_html(stripslashes($_POST["text_color_other_months"]))) : '');
  $bg_color_other_months = ((isset($_POST["bg_color_other_months"])) ? esc_sql(esc_html(stripslashes($_POST["bg_color_other_months"]))) : '');
  ...
  $event_title_color = ((isset($_POST["event_title_color"])) ? esc_sql(esc_html(stripslashes($_POST["event_title_color"]))) : '');
  $current_day_border_color = ((isset($_POST["current_day_border_color"])) ? esc_sql(esc_html(stripslashes($_POST["current_day_border_color"]))) : '');
  ...
  $sundays_bg_color = ((isset($_POST["sundays_bg_color"])) ? esc_sql(esc_html(stripslashes($_POST["sundays_bg_color"]))) : '');
  $sundays_font_size = ((isset($_POST["sundays_font_size"])) ? esc_sql(esc_html(stripslashes($_POST["sundays_font_size"]))) : '');
  $other_days_font_size = ((isset($_POST["other_days_font_size"])) ? esc_sql(esc_html(stripslashes($_POST["other_days_font_size"]))) : '');
  $show_time = ((isset($_POST["show_time"])) ? esc_sql(esc_html(stripslashes($_POST["show_time"]))) : '');
  $show_event = ((isset($_POST["show_event"])) ? esc_sql(esc_html(stripslashes($_POST["show_event"]))) : '');
